...
public class Music {  // implements MetaEventListener
    ...
    public void startUp(String name) {
        ...
        userName = name;
        try {
            Socket sock = new Socket("192.168.1.101", 4242);
    ...
    public void buildGUI() {
        ...
        JButton saveButton = new JButton("Save this config");
        saveButton.addActionListener(new MySaveListener());
        buttonBox.add(saveButton);

        JButton loadButton = new JButton("Load last config");
...
//============================================================== inner class listeners
    ...
    public class MyReadListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            try {
                ObjectInputStream stream = new ObjectInputStream(new FileInputStream(myFile));
                boolean[] checkBoxState = (boolean[]) stream.readObject();
    ...
    public class MySaveListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            try {
                ObjectOutputStream stream = new ObjectOutputStream(new FileOutputStream(myFile));
